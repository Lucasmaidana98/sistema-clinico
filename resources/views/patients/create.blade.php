...
@section('title', 'Nuevo Paciente - Sistema Clínico')
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600">Completa la información del paciente</p>
                </div>
        ...
        <form method="POST" action="{{ route('patients.store') }}" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="identification_type" 
                            ...
                            <option value="tarjeta_identidad" {{ old('identification_type') === 'tarjeta_identidad' ? 'selected' : '' }}>Tarjeta de Identidad</option>
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="address" 
                                  ...
                                  placeholder="Ingresa la dirección completa">{{ old('address') }}</textarea>
                        @error('address')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="allergies" 
                                  ...
                                  placeholder="Describe las alergias conocidas">{{ old('allergies') }}</textarea>
                        @error('allergies')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="medical_history" 
                                  ...
                                  placeholder="Describe el historial médico relevante">{{ old('medical_history') }}</textarea>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                <a href="{{ route('patients.index') }}" class="px-6 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors">
                    Cancelar
                </a>
